    ...
    <div class="center_container dark:!bg-[#15151524] bg-white">
      ...
      <div class="d-flex gap-5">
        <div class="w-50">
          ...
          <div
            class="compose_text text-black dark:!text-white"
          ...
          <div class="concentrated_card dark:!bg-[#DCEEF605] bg-white">
            ...
            <div class="compose_text dark:!text-white text-black fw-light">
              {{ $t('pair') }}
            </div>
            <div class="d-flex gap-3">
              ...
              <div
                @click="
                  () =>
                    !disableTokenSelection ? tokenSelectModalOpen(1) : null
                "
              ...
              <div
                @click="
                  () =>
                    !disableTokenSelection ? tokenSelectModalOpen(2) : null
                "
                class="selector_button dark:!bg-[#DCEEF605] bg-white"
              >
                <img
            ...
            <div
              class="compose_text dark:!text-white text-black fw-light mt-3 mb-2"
            >
              {{ $t('price_range') }}
            </div>
            <div class="price_range_container dark:!bg-[#07091C] bg-white">
              <div class="d-flex gap-3 justify-content-between">
                ...
                <div class="price_range_card dark:!bg-[#07091C] bg-white">
                  ...
                  >
                    ...
                    >
                      <div class="dark:!text-[#c1c8ce] text-black">
                        {{ $t('min_per') }}
                      </div>
                      <div
              ...
              <div
                class="compose_text dark:!text-white text-black fw-light mt-3 mb-3"
              >
                {{ $t('range_type') }}:
              </div>
              <div
                v-if="concentratedLiquidityStep > 0"
                class="fee_tier_container dark:!bg-[#DCEEF605] bg-white"
              >
                <div
                  :class="
                    type.selected
            ...
            <div class="price_range_container dark:!bg-[#07091C] bg-white">
              <div class="d-flex flex-column gap-4 position-relative">
                ...
                <div
                  class="flex dark:!bg-[#07091C] bg-white"
                  style="
...
const disableTokenSelection = computed(
  () => route.query.tokens && route.query.tokens.length == 2,
)
