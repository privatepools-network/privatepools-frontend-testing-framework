      ...
      <div class="portfolio mt-4">
        ...
        <div class="portfolio-financial-statement">
          <PortfolioFinancialStatement
            ...
            :user="account"
            v-if="activeTab == 'Financial Statement'"
          >
          </PortfolioFinancialStatement>
        </div>
          ...
          <div class="portfolio-table__wrapper">
            ...
            >
              <template
                v-slot:default="{
                  dataCell,
                  dataCellKey /*, tokenName, fieldName*/,
                }"
              >
                <div>
                  ...
                  />
                  <div
                    v-else-if="['% of Pool', 'Avg APR'].includes(dataCellKey)"
                  ...
                  >
                    <div v-if="dataCell.variation < 0">
                      {{ dataCell.amount }}%
                      <span v-if="dataCell.variation" class="text-danger"
                        >{{ dataCell.variation }}%</span
                      >
                    </div>
                    <div v-else>
                      {{ dataCell.amount }}%
                      <span class="text-success" v-if="dataCell.variation"
                        >+{{ dataCell.variation }}%</span
                      >
                    </div>
                  </div>
                  <div
                    v-else-if="dataCellKey === 'Fees'"
                    class="text-truncate file-table-cell"
                    data-coreui-toggle="tooltip"
                    data-coreui-placement="left"
                    :title="dataCell"
                  >
                    <div>${{ dataCell.amount }}</div>
                  </div>
                  <div
                    v-else-if="dataCellKey === 'Number of Trades'"
                    class="text-truncate file-table-cell"
                    data-coreui-toggle="tooltip"
                    data-coreui-placement="left"
                    :title="dataCell"
                  ...
                  >
                    ...
                    <div v-else>
                      ${{ dataCell.amount }}
                      <span v-if="dataCell.variation" class="text-success"
                        >+{{ dataCell.variation }}%</span
                      >
                    </div>
                  </div>
