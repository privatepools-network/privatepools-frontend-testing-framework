              ...
              <div class="actions-cell" v-if="fieldName === 'Actions'">
                ...
                <svg v-if="dataCell === 'Withdraw'" width="16" height="16" viewBox="0 0 16 16" fill="none"
                  ...
                  <g clip-path="url(#clip0_1253_7859)">
                    <path d="M3.3335 8H12.6668" stroke="#01B47E" stroke-width="1.33333" stroke-linecap="round"
                      stroke-linejoin="round" />
                  </g>
                  <defs>
...
const assetsBreakdownChartMOCK = ref({
  ...
  colors: ['rgba(230, 177, 12, 1)', 'rgba(1, 180, 126, 1)', 'rgba(248, 71, 71, 1)', 'rgba(194, 119, 237, 1)', 'rgba(0, 199, 242, 1)'],
  series: [44, 15, 11, 6, 2]
})
