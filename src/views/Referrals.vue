<template>
  <MainCard>
    <div style="color: white; font-size: clamp(14px, 0.8vw, 20px); font-weight: 700" class="my-3">
      Referrals
    </div>
    <div
      style="color: white; font-size: clamp(10px, 0.8vw, 14px); font-weight: 500; width: 38%"
      class="my-1"
    >
