<template>
  ...
  <MainCard v-else-if="!visibleDepositComponent && !visibleWithdrawComponent">
      ...
      <div class="d-flex justify-content-between align-items-center mt-3">
        <div>
          <Tabs
            ...
            :tabsOptions="['Overall view', 'My view']"
    ...
    <WithdrawModal
      ...
      :pool="pool"
      :tokens="tokens"
      :visibleWithdrawModal="visibleWithdrawModal"
    ...
    >
      ...
      <CRow id="pool-stats-row">
        <PoolsDetailsDiagrams
          v-if="assetsPerformance && poolTradesData && poolProfitsData"
