      ...
      <div class="compose_choose">
        ...
        <div v-if="activeStep === 1" class="compose_choose_inner_container">
            ...
            <div class="d-flex align-items-center gap-2">
              ...
              >
                ...
                >
                  ...
                  />
                  <path
                    d="M13.5072 3.99967V13.333C13.5072 13.6866 13.3667 14.0258 13.1166 14.2758C12.8666 14.5259 12.5275 14.6663 12.1738 14.6663H5.50716C5.15354 14.6663 4.8144 14.5259 4.56435 14.2758C4.3143 14.0258 4.17383 13.6866 4.17383 13.333V3.99967M6.17383 3.99967V2.66634C6.17383 2.31272 6.3143 1.97358 6.56435 1.72353C6.8144 1.47348 7.15354 1.33301 7.50716 1.33301H10.1738C10.5275 1.33301 10.8666 1.47348 11.1166 1.72353C11.3667 1.97358 11.5072 2.31272 11.5072 2.66634V3.99967"
                    stroke="#7EF6B2"
                    stroke-width="1.33333"
                    stroke-linecap="round"
                    stroke-linejoin="round"
          ...
          <div class="d-flex justify-content-between mt-5">
            ...
            <div
              class="compose_text"
              v-if="tokensData && tokensData.length > 0 && tokensData[0].symbol"
            >
              {{
                tokensData
                  .filter((td) => td.weight != '')
            ...
            <div>
              ...
              <div>
                ...
                <div class="mt-2">
                  <Slider
                    v-if="lineNumbers.length > 0"
                    @change="(value) => OnSliderValueChange(tokenIndex, value)"
                    :tooltips="false"
                    :min="0"
              ...
              <div class="position-relative">
                ...
                >
                  <circle
                    ...
                    cy="15"
                    r="14.5"
                    :stroke="activeStep === 2 ? '#01b47e' : 'white'"
                  />
                </svg>
                <div
            ...
            <div class="position-relative">
              ...
              >
                <circle
                  ...
                  cy="15"
                  r="14.5"
                  :stroke="activeStep === 3 ? '#01b47e' : 'white'"
                />
              </svg>
              <div
            ...
            <div class="position-relative">
              ...
              >
                <circle
                  ...
                  cy="15"
                  r="14.5"
                  :stroke="activeStep === 4 ? '#01b47e' : 'white'"
                />
              </svg>
              <div
                :class="
      ...
      <div class="compose_chart">
        ...
        <div class="chart_container">
          ...
          <div v-else class="d-flex flex-column text-white align-items-center justify-content-center" >
            <svg
            style="filter: drop-shadow(0 0 0.7rem #01B47E);"
              fill="#01b47e"
              version="1.1"
              id="Capa_1"
              xmlns="http://www.w3.org/2000/svg"
