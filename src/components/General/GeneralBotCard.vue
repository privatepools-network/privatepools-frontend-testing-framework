<template>
  <div class="arbitrage_bot_card bg-white dark:!bg-[#22222224] py-3 px-4">
    <div
      class="d-flex align-items-center justify-content-between text-black dark:!text-white gap-2 flex-wrap"
    >
      <div
        class="d-flex align-items-center justify-content-between text-black dark:!text-white w-100"
      ></div>
    </div>
    ...
    <div class="px-2">
        ...
        <CCollapse :visible="visibleTotalRevenue">
          ...
          >
            <div class="d-flex flex-column gap-1">
              <div
                class="d-flex align-items-center justify-content-between text-black dark:!text-white"
              >
      ...
      <div class="mb-xxl-4 mb-2">
        <div
          @click="clickOnVisibleTotalTrades()"
          class="visible_head"
          style="cursor: pointer"
        >
          <div
            ...
            <div>
              <div>
                <img
                  :src="arrow_up"
                  :width="10"
                  :class="!visibleTotalTrades ? 'toggle-down' : 'toggle-up'"
                />
              </div>
            </div>
            <div
      ...
      <div style="cursor: pointer" class="visible_head">
        <div class="d-flex align-items-center gap-2" style="margin-left: -10px">
          ...
          <div style="width: 100%">
            ...
            >
              <div
                class="text-[13px] mt-[10px] mb-[5px] font-['Syne',_sans-serif] font-semibold"
              >
                {{
