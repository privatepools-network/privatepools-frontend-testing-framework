  ...
  <div style="height: 92%; padding-top: 7px">
    <div class="d-flex justify-content-between align-items-center">
      <div class="d-flex align-items-center gap-1">
        <img :src="accountIcon" />
        <div class="address_text">{{ computedAddress }}</div>
      </div>
    ...
    <div class="d-flex flex-column h-100 gap-3 mt-3">
      <div class="d-flex flex-column">
        <div class="balance_text">$510.98</div>
      ...
      <div v-else-if="sidebarTab === 'Pools'" class="h-100">
            ...
            <div class="d-flex align-items-center gap-2">
              ...
              >
                <g clip-path="url(#clip0_71_3305)">
                  ...
                  <path
                    d="M2.25263 49.9627L34.9111 37.3732L22.3216 4.71467L-10.3369 17.3042L2.25263 49.9627Z"
                    fill="#F5841F"
                  />
                  <path
                    d="M-10.0142 -8.54158L-15.6387 26.0034L18.9063 31.6279L24.5308 -2.91708L-10.0142 -8.54158Z"
                    fill="#40B66B"
                  />
                  <path
                    d="M12.5634 -20.5779L-22.1006 -25.4219L-26.9446 9.24213L7.71941 14.0861L12.5634 -20.5779Z"
                    fill="#FF007A"
                  />
                </g>
                <defs>
        ...
        >
          ...
          <div class="text-white">No pools yet</div>
      ...
      >
        <div>
          ...
          <div class="d-flex flex-column gap-2">
            <div
              v-for="(item, i) in mockActivity.filter((el) => el.unix < 10)"
              :key="`${i}-token`"
              class="p-2 d-flex align-items-center justify-content-between gap-2"
            >
              <div class="d-flex align-items-center gap-2">
        ...
        <div>
          ...
          <div class="d-flex flex-column gap-2">
            <div
              v-for="(item, i) in mockActivity.filter((el) => el.unix > 10 && el.unix < 100)"
              :key="`${i}-token`"
              class="p-2 d-flex align-items-center justify-content-between gap-2"
            >
              <div class="d-flex align-items-center gap-2">
        ...
        <div>
          ...
          <div class="d-flex flex-column gap-2">
            <div
              v-for="(item, i) in mockActivity.filter((el) => el.unix > 100)"
              :key="`${i}-token`"
              class="p-2 d-flex align-items-center justify-content-between gap-2"
            >
              <div class="d-flex align-items-center gap-2">
...
const props = defineProps(['isConnectedToWeb3'])
const emit = defineEmits(['toggleSettings', 'toggleToWallets'])
...
async function disconnectFromWallet() {
  props.isConnectedToWeb3 = localStorage.removeItem('isConnectedToWeb3')
