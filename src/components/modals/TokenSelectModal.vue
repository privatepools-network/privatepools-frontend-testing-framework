    ...
    <CModalBody>
      <div class="modal_body_inside">
        <div>
          ...
          <CInputGroup
            class="d-flex align-items-normal justify-content-start search-input-group"
          >
          ...
          <div class="mt-3 tokens_container">
            ...
            >
              <div class="d-flex align-items-center">
                <img
                  :src="
                    token.logoURI || getTokenEntity(token.symbol, 'short').icon
                  "
                  width="60"
                  class="p-2"
                />
...
const filteredPossibleTokens = computed(() =>
  props.possibleComposeTokens.filter(
    (t) =>
      filterName.value == '' ||
