<template>
  <div
    ...
    :class="{ 'multiselect--active': true, 'multiselect--disabled': disabled, 'multiselect--above': isAbove }"
    @focus="activate()"
    ...
    <slot name="caret" :toggle="toggle">
      <div @mousedown.prevent.stop="toggle()" class="multiselect__select">
        ...
        >
          <path
            fill="#A3A4A5"
            d="M3.055 0.329346L13 10.2187L22.945 0.329346L26 3.37388L13 16.3293L0 3.37388L3.055 0.329346Z"
          />
        </svg> -->
      </div>
    </slot>
