<template>
  ...
  <div class="concentrated_card" style="height: 90%">
    ...
    >
      <div class="compose_text">
        <span style="color: #00c9ff">Min Price:</span> 18.503 (WBTC = $34,652)
      </div>
      <div class="compose_text">
        <span style="color: #00c9ff">Max Price:</span> 18.503 (WETH = $1,503)
      </div>
    </div>
      ...
      <div class="position_range_container">
        <div class="d-flex gap-2 align-items-center">
          ...
          <div class="d-flex flex-column gap-1">
            <div style="color: white">5,043.63 WBTC</div>
        ...
        <div class="d-flex gap-2 align-items-center">
          ...
          <div>
            <img :src="getTokenEntity('ETH', 'short').icon" width="30" />
          </div>
        </div>
      </div>
    </div>
