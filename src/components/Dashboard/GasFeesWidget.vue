        ...
        <template #popper>
          <div style="
            ...
            <div style="display: flex; flex-direction: column; font-size: clamp(10px, 0.8vw, 14px)">
              <p>
                This component consolidates gas fee data across multiple time periods, allowing you to assess your
                transaction costs comprehensively.
