        ...
        >
          ...
          >
            ...
            >
              ...
              <span
                class="chip_token_weight text-[#475569] dark:!text-[#8f8f8f]"
                v-if="pool['LiquidityType'] === 'WP'"
                >{{ parseFloat(item.weight).toFixed(0) }}%</span
              >
            </div>
          </div>
          <div
    ...
    <CCollapse :visible="visibleDetails">
      <div class="details-el">
        ...
        >
          ...
          <div class="details-el__col">
            <div :class="pool['LiquidityType'] === 'CL' ? 'green' : 'orange'" class="details-el__title d-flex gap-1 align-items-center  w-fit px-2 py-1 rounded font-['Syne',_sans-serif] bg-[#DCEEF60D] ">
              {{ $t('liquidity_added') }}
              <div class="details-el__circle"></div>
            </div>
