            ...
            <div class="d-flex align-items-end justify-content-between mt-3">
              <div v-if="pool['LiquidityType'] === 'WP'" style="font-size: 9px; font-weight: 700"
                ...
                <svg width="15" height="10" viewBox="0 0 15 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <defs>
                    <linearGradient id="paint0_linear_157_1422" x1="12.3" y1="-4.60005" x2="3.79087" y2="6.52723"
          ...
          <div class="details-el__col">
            ...
            <div style="font-size: 18px; font-weight: 700">
              ...
              <svg width="22" height="15" viewBox="0 0 22 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <defs>
                  <linearGradient id="paint0_linear_157_1467" x1="18.04" y1="-6.89995" x2="5.204" y2="9.51256"
                    gradientUnits="userSpaceOnUse">
                    <stop stop-color="#F21BF6" />
                    <stop offset="1" stop-color="#FED533" />
                  </linearGradient>
...
const isUserStaked = computed(() => userPools.value.find((item) => item.id == pool.value.id))
