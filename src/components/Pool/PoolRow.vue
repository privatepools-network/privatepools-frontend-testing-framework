        ...
        <div class="pools-row__info" style="
          ...
          <div class="pools-row__value" v-for="(item, i) in pool['Pool Weight'][0]" :key="`${i}-tokens`">
            <div class="d-flex gap-2 chip_token align-items-center !bg-[#EAF0F6] dark:!bg-[#22222224]">
              ...
              <span class="flex items-center chip_token_weight text-[#475569] dark:!text-[rgb(143,143,143)]"
        ...
        <div class="pools-row__info">
          <div class="pools-row__value">
            <div class="flex items-center font-['Roboto_Mono',_monospace]">
              <CounterAnimation :currency="''" :value="Number(
                currentCurrency == 'USD'
                  ? pool['TVL']
      ...
      <div class="pools-row__col text-black dark:!text-white">
        <div class="pools-row__info">
          <div class="pools-row__value flex items-center">
            <CounterAnimation :currency="''" :value="Number(
              pool[
              `APR${filters && filters['APR'] ? ` ${filters['APR']}` : ''
              }`
              ],
            ).toFixed(0)
              " />%
...
const { pool, index, inactive, isActions, userPools, filters, rewardsData } = toRefs(props)
