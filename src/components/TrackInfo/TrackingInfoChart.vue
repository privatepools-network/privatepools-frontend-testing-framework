...
const optionObj = ref({
  ...
  yAxis: [
    ...
    yAxisInstance('Revenue / Profits', width > 768 ? showRevenueProfits : false, 60, '#01B47E'),
    yAxisInstance('Trades / Gas Fees', width > 768 ? showTradesGasFees : false, 120, '#77aaff'),
    yAxisInstance('APR / Volatility Index', width > 768 ? showAPRVolatility : false, 180, '#FFD700'),
  ],
  grid: [
    {
      left: width > 768 ? '5%' : '9%',
